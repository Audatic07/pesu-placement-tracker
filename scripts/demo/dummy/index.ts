 ...
 *
 * The FormData step matters and is the reason this harness differs from the
 * 9999 fixture, which starts at the schema. Encoding each row the way a browser
 * posts it means the blank-field-to-undefined rule, the unchecked checkbox, the
 * comma-separated locations and the parallel component arrays are all exercised
 * rather than assumed. createOffer then does what it always does: derives the
